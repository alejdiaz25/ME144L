...
filename = '/Users/alejandrodiaz/Downloads/DEMO1/test1774379497.csv'  # NOTE: Change to your dynamic oscillation file
...
# ------------------- Drop First Peak (transient startup) -------------------
# The first detected peak often captures a nonlinear transient and skews the
# log-decrement regression. Drop it and use the second peak as A0.
peaks_trimmed      = peaks_trimmed[1:]
peak_vals_trimmed  = peak_vals_trimmed[1:]
peak_times_trimmed = peak_times_trimmed[1:]
